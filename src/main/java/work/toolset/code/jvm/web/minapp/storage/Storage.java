...
public abstract class Storage
{
    ...
    public static CloudFile uploadFile(String filename, String categoryId, byte[] data) throws Exception
    {
        ...
        MultipartBody multipartBody = new MultipartBody.Builder()
                ...
                .addFormDataPart(PART_FILE, filename, RequestBody.create(data, null))
                .build();
    ...
    public static void uploadFileInBackground(
            final String filename, final String categoryId, final byte[] data, final BaseCallback<CloudFile> cb
    )
    {
    ...
    public static void fileInBackground(final String id, BaseCallback<CloudFile> cb)
    {
        Util.inBackground(cb, new Callable<CloudFile>()
        {
            @Override
    ...
    public static void filesInBackground(final Query query, BaseCallback<PagedList<CloudFile>> cb)
    {
    ...
    public static void deleteFilesInBackground(final Collection<String> ids, BaseCallback<Void> cb)
    {
    ...
    public static void categoryInBackground(final String id, BaseCallback<FileCategory> cb)
    {
    ...
    public static void categoriesInBackground(final Query query, BaseCallback<PagedList<FileCategory>> cb)
    {
