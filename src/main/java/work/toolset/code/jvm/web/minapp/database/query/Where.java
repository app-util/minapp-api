...
public class Where {
    ...
    public Where withinRegion(String lvalue, GeoPoint center, float maxDistance, float minDistance) {
        _and(WhereOperator.NEAR_SPHERE, lvalue, new WithinRegion(center, maxDistance, minDistance));
        return this;
    }
    ...
    public static Where and(Where lvalue, Where rvalue) {
    ...
    public static Where or(Where lvalue, Where rvalue) {
        if (lvalue == null && rvalue == null) {
            return new Where();
        }
