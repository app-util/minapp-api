...
public class Query extends HashMap<String, String>
{
    ...
    public Query put(Where where)
    {
        ...
        if (json.equals("") || "null".equalsIgnoreCase(json))
        {
            remove(WHERE);
        }
        else
    ...
    public @Nullable
    String get(Operator operator, String key)
    {
        if (key != null)
        {
            key = key + "__" + operator.value;
    ...
    public Query limit(Number limit)
    {
        put(LIMIT, limit);
        return this;
    }
    
    public Query offset(Number offset)
    {
        put(OFFSET, offset);
        return this;
    }
    
    public Query orderBy(Collection<String> orderBy)
    {
    ...
    public Query keys(Collection<String> keys)
    {
