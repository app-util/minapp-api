...
public abstract class Util
{
    ...
    //todo:修改所有后台回调的功能
    public static <T> void inBackground(final BaseCallback<T> cb, final Callable<T> callable)
    {
        /*
        Global.submit(
                new Runnable()
    ...
    public static Map singleMap(Object key, Object value)
    {
    ...
    String readString(InputStream input)
    {
        return readString(input, "utf-8");
    }
    
    public static @Nullable
    String readString(InputStream input, String charset)
    {
        try
        {
     ...
     */
    public static @Nullable
    String joinToNull(Collection data)
    {
