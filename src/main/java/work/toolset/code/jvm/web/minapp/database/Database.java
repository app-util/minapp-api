...
public abstract class Database {
     ...
     * @throws Exception
     */
    static Record fetch(Table table, String recordId, Query query) throws Exception {
